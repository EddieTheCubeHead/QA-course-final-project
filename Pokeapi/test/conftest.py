...
from models.pokemon.growth_rate import GrowthRate
from models.pokemon.pokeathlon_stat import PokeathlonStat
...
from models.pokemon.type import Type
from models.utility.language import Language
...
FETCHABLE_TYPES = (Berry, BerryFirmness, BerryFlavor, ContestType, EncounterMethod, EncounterCondition,
                   ...
                   PokemonHabitat, PokemonShape, PokemonSpecies, Stat, Type, Language)
